...
@Component({
  selector: 'app-product-col-right',
  templateUrl: './product-col-right.component.html',
  styleUrls: ['./product-col-right.component.scss']
})
export class ProductColRightComponent implements OnInit {
